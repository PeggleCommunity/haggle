...
std::unordered_map<callbacks::type, std::vector<callback_<void __cdecl(Sexy::LevelScreen*, unsigned int)>>> callbacks::doplay_callbacks_;
...
void callbacks::on_doplay(callback_<void __cdecl(Sexy::LevelScreen*, unsigned int)> callback)
{
	callbacks::doplay_callbacks_[callbacks::type::doplay].emplace_back(callback);
}
...
void callbacks::run_doplay_callbacks(Sexy::LevelScreen* level_screen, unsigned int a3)
{
	for (const auto doplay : callbacks::doplay_callbacks_[callbacks::type::doplay])
	{
